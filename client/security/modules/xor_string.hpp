...
////////////////////////////////////////////////////////////////////
//Use Compile-Time as Seedi
#define Seedi ((__TIME__[7] - '0') * 1  + (__TIME__[6] - '0') * 10  + \
...
constexpr int LinearCongruentGenerator(int Rounds) {
	return 1013904223 + 1664525 * ((Rounds > 0) ? LinearCongruentGenerator(Rounds - 1) : Seedi & 0xFFFFFFFF);
}
...
#define bb_xor_(X, String) CXorString<ConstructIndexList<sizeof(String)-1>::Result> X(String)